...
builder.Services.AddSingleton<ICategoriaProduto, RepositoryCategoriaProduto>();

// SERVIÇO DOMINIO
builder.Services.AddSingleton<IServiceProduto, ServiceProduto>();
builder.Services.AddSingleton<IServiceCategoriaProduto, ServiceCategoriaProduto>();
...
var config = new AutoMapper.MapperConfiguration(cfg =>
{
    ...
    cfg.CreateMap<CategoriaProdutoDTO, CategoriaProduto>();
    cfg.CreateMap<CategoriaProduto, CategoriaProdutoDTO>();
});
